...
public class App {
    ...
    public static void main(String[] args) {
        ...
        properties.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, info.kafka4);
        ...
        try{
            do{//consumer로 받아온 message를 Records 객체에 저장, Records 객체는 Iterable 하다
                ...
                for(ConsumerRecord<String, String> record : records) {
                    ...
                    Map<String,Object> fireDetectionModule = (Map<String,Object>) jsonMap.get("fireDetectionModule");
                    ArrayList<Object> detectionInfo = (ArrayList<Object>) fireDetectionModule.get("detectionInfo");

                    if(detectionInfo.size() == 0) {
